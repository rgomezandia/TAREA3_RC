...
print ("\nDebe enviar el numero de las caras del dado y su cantidad con un limite de hasta 10 dados separados por un espacio.\n\n") #solo como referencia
...
try:
    while True:
        ...
        print ("Servidor >> " + re.sub("b|\'", '', str(recibido)))
